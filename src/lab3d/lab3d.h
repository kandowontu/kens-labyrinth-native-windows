...
/* The Windows SDK exposes OpenGL 1.1 declarations only. */
...
#define CONTROL_SOUND_UP 21
#define CONTROL_MUSIC_DOWN 22
...
EXTERN K_INT16 cheat_godmode = 0, cheat_noclip = 0;
EXTERN K_INT16 cheat_infinite_money = 0, cheat_all_keys = 0;
EXTERN K_INT16 cheat_max_weapons = 0, cheat_infinite_powerups = 0;
EXTERN K_INT16 cheat_extra_lives = 0, cheat_compass = 0;
EXTERN K_INT16 cheat_next_board = 0;
EXTERN K_INT16 cheat_warp_board = -1;
EXTERN K_INT16 cheat_menu_requested = 0;
#else
EXTERN unsigned char paldef[16][3];
EXTERN unsigned char opaldef[16][3];
EXTERN K_UINT16 pcfreq[63];
...
EXTERN K_INT16 cheat_godmode, cheat_noclip;
EXTERN K_INT16 cheat_infinite_money, cheat_all_keys;
EXTERN K_INT16 cheat_max_weapons, cheat_infinite_powerups;
EXTERN K_INT16 cheat_extra_lives, cheat_compass;
EXTERN K_INT16 cheat_next_board;
EXTERN K_INT16 cheat_warp_board;
EXTERN K_INT16 cheat_menu_requested;
#endif
...
EXTERN unsigned char keydefs[numkeys];
...
EXTERN double aspw, asph;

/* Faster menu drawing... */
EXTERN int menuleft,menutop,menuwidth,menuheight,menuing;

EXTERN void (*gfxInit)(void);
EXTERN void (*gfxInitFailsafe)(void);
EXTERN void (*gfxSwapBuffers)(void);
EXTERN void (*gfxClearScreen)(void);
EXTERN void (*gfxClearScreenScrollyPalette)(void);
EXTERN void (*gfxUploadImage)(int, unsigned char *, unsigned char);
EXTERN void (*gfxTransitionTexture)(int, int, int);
EXTERN void (*gfxUpdateImage)(int);
EXTERN void (*gfxFlush)(void);
EXTERN void (*gfxDrawFront)(void);
EXTERN void (*gfxDrawBack)(void);
EXTERN void (*gfxScreencapture)(void);
EXTERN void (*fade)(K_INT16);
EXTERN void (*gfxFilter)(unsigned char);
EXTERN void (*gfxTextureDepth)(int);
EXTERN void (*gfxUploadPartialOverlay)(int, int, int, int);
EXTERN void (*gfxUploadOverlay)(void);
EXTERN void (*ShowPartialOverlay)(int, int, int, int, int);
EXTERN void (*pictur)(K_INT16, K_INT16, K_INT16, K_INT16, K_INT16);
EXTERN void (*picrot)(K_UINT16, K_UINT16, K_INT16, K_INT16);
EXTERN void (*setdarkenedpalette)(void);
EXTERN void (*updateoverlaypalette)(K_UINT16, K_UINT16, unsigned char *);
EXTERN void (*settransferpalette)(void);
EXTERN void (*drawvolumebar)(int, int, float);
EXTERN void (*flatsprite)(K_UINT16, K_UINT16, K_INT16, K_INT16, K_INT16);
EXTERN void (*doordraw)(K_UINT16, K_UINT16, K_INT16, K_UINT16, K_UINT16);
void softwareInit(void);
void softwareInitFailsafe(void);
void softwareSwapBuffers(void);
void softwareClearScreen(void);
void softwareClearScreenScrollyPalette(void);
void softwareUploadImage(int i, unsigned char *walsegg, unsigned char create);
void softwareTransitionTexture(int left, int texture, int right);
...
void softwarePictur(K_INT16 x,K_INT16 y,K_INT16 siz,K_INT16 ang,
		    K_INT16 walnume);
void softwarePicrot(K_UINT16 posxs, K_UINT16 posys, K_INT16 poszs,
		    K_INT16 angs);
void softwareSetDarkenedPalette(void);
void softwareUpdateOverlayPalette(K_UINT16 start,K_UINT16 amount,
				unsigned char *cols);
void softwareSetTransferPalette(void);
